...
void check_path(vars_t *vars)
{
	...
	if (check_file_status(vars->av[0]))
		r = _execute(vars);
	else
	{
...
/**
 * _execute - executes the command in the current working directory
 * @vars: pointer to struct of variables
 *
...
/**
 * check_file_status - checks if the command is a part of a path
 * @str: command
 *
